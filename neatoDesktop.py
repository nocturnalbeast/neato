...
print('''neato! will create a neatoDesktop folder and sort files into sub-folders by file type. 
Do you want neato to clean directory: ''' + cwd + '''?''')
